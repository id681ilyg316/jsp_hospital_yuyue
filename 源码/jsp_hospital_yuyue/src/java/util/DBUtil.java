...
public class DBUtil {
    private static  String url="jdbc:mysql://www.icodedock.com:3306/hospital_yuyue?characterEncoding=utf8&serverTimezone=UTC";
    private static final String user="hospital_yuyue";
    private static final String password="hospital_yuyue";
